(function() {
  ...
  function validerChamp(champ) {
    switch (champ.name) {
      ...
      case "username": {
        if (validerUsername(champ.value)) {
          champ.classList.add("valid");
          champ.classList.remove("invalid");
        } else {
          champ.classList.add("invalid");
  ...
  function validerFormulaire(formDataObject) {
    // validation nom
    if (formDataObject.nom.length < 2) {
      document.getElementsByName("nom").forEach(function(element) {
    ...
    // validation prenom
    if (formDataObject.prenom.length < 2) {
      document.getElementsByName("prenom").forEach(function(element) {
        element.classList.remove("valid");
        element.classList.add("invalid");
      });
    } else {
    ...
    // validation username
    if (formDataObject.username.length < 3) {
      document.getElementsByName("username").forEach(function(element) {
        element.classList.remove("valid");
        element.classList.add("invalid");
      });
    } else {
